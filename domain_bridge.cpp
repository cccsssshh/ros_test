...
int main(int argc, char ** argv)
{
  ...
  domain_bridge.bridge_service<interface_package::srv::OrderInfo>("order_info", 1, 0, options.remap_name("order_info_1"));
  domain_bridge.bridge_service<interface_package::srv::OrderInfo>("order_info", 2, 0, options.remap_name("order_info_2"));
  domain_bridge.bridge_service<interface_package::srv::OrderTracking>("order_tracking_1", 0, 1, options.remap_name("order_tracking"));
